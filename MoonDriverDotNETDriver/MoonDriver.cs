...
namespace MoonDriverDotNET.Driver
{
    ...
    {
        public Action<ChipDatum> WriteOPL4Register = null;
        public GD3 gd3 = null;
        private double SampleRate;
        private bool Stopped;
        private uint vgmCurLoop;
        ...
        public GD3 getGD3Info(MmlDatum[] buf, uint vgmGd3)
        {
            ...
            {
                adrTag -= 0x8000;
                gd3.TrackName = Common.Common.getNRDString(buf, ref adrTag);
                gd3.TrackNameJ = Common.Common.getNRDString(buf, ref adrTag);
                gd3.GameName = Common.Common.getNRDString(buf, ref adrTag);
                gd3.GameNameJ = Common.Common.getNRDString(buf, ref adrTag);
                gd3.SystemName = Common.Common.getNRDString(buf, ref adrTag);
                gd3.SystemNameJ = Common.Common.getNRDString(buf, ref adrTag);
                gd3.Composer = Common.Common.getNRDString(buf, ref adrTag);//Track author
                gd3.ComposerJ = Common.Common.getNRDString(buf, ref adrTag);//Track author(jp)
                gd3.Version = Common.Common.getNRDString(buf, ref adrTag);//Release date
                gd3.Converted = Common.Common.getNRDString(buf, ref adrTag);//Programmer
                gd3.Notes = Common.Common.getNRDString(buf, ref adrTag);//Notes
            }
