...
namespace MoonDriverDotNET.Common
{
    public static class msg
    {
        ...
        private static string otherLangFilename = Path.Combine("lang", "MoonDriverDotNETmessage.{0}.txt");
        private static string englishFilename = Path.Combine("lang", "MoonDriverDotNETmessage.txt");
